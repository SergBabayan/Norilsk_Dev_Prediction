...
X = df[['Employment_Count', 'Average_Salary', 'Unemployment_Rate', 'Population']]  # Независимые переменные
...
forecast_X = sm.add_constant(forecast_df[['Employment_Count', 'Average_Salary', 'Unemployment_Rate', 'Population']])
